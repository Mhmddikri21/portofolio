                ...
                <div className="space-y-8">
                    ...
                    <div className="grid gap-6">
                        {WORK_EXPERIENCE.map((exp, index) => (
                            <article
                                key={exp.id}
                                className="group rounded-2xl border bg-card p-6 md:p-8 shadow-sm hover:shadow-lg hover:shadow-primary/10 transition-all animate-fadeInUp"
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {EDUCATION.map((edu, index) => (
                            <div
                                key={edu.id}
                                className="p-6 rounded-2xl border bg-card animate-scaleIn"
